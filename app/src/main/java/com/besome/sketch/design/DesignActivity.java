    ...
    private void showCurrentActivitySrcCode() {
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                EditorColorScheme draculaColorScheme = CodeEditorColorSchemes.loadTextMateColorScheme(CodeEditorColorSchemes.THEME_DRACULA);
                editor.setColorScheme(draculaColorScheme);
